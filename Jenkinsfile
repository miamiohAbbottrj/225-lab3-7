pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/abbottrj'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/miamiohAbbottrj/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('abbottrj-225')                                                         //<------your MiamiID
    }
